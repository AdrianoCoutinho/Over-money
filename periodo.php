<?php
        ...
        $pegardatas = "SELECT * FROM movimentos where data BETWEEN  '$inicio' AND '$fim'";
        $result3 = $conn->query($pegardatas);

		$sql = "SELECT * FROM `movimentos` WHERE `tipo` = '1'  AND data BETWEEN '$inicio' AND '$fim'";
		$result = $conn->query($sql);

        $sql2 = "SELECT * FROM `movimentos` WHERE `tipo` = '2' AND data BETWEEN '$inicio' AND '$fim'";
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                  <div class="d-flex menu">
                      <a href="home.php"><button class="btn btn-link" type="button"><i class="bi bi-house-door-fill fs-4 color-secundary"></i></button></a>
                      <a href="todas.php"><button class="btn btn-link" type="button"><i class="fs-4 bi bi-currency-exchange color-black"></i></button></a>
    ...
    <main>
        <div class="container-lg">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 d-flex mt-4 justify-content-center align-items-center">
                    ...
                    <span class="fs-5 shadow-lg text-center" id="periodo">
                        <?php
		...
		?>
                            ...
                            <div class="col-12 mb-4 text-center">
                                <button type="button" onclick="window.location.href='todas.php'" class="btn button-default">Ver todas</button>
                            </div>
